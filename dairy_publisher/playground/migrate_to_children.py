...
# childrenコレクションにデータを追加
for child_id, child_data in children_data.items():
    print(f"Adding child: {child_id}...")
    db.collection('children').document(child_id).set(child_data)
    print(f"Successfully added {child_id}")

print("\nAll children data added successfully!")
print("\nNew URLs will be:")
print("- https://hackason-464007.web.app/children/taro_2020")
print("- https://hackason-464007.web.app/children/hana_2022")